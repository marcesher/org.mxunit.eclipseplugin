 ...
 */
    ...
    private java.lang.String RemoteFacadeCfc_address = "http://localhost:8090/mxunit/framework/RemoteFacade.cfc";
    ...
    public org.mxunit.eclipseplugin.actions.bindings.generated.bluedragon.RemoteFacade getRemoteFacadeCfc() throws javax.xml.rpc.ServiceException {
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://mxunit/framework/RemoteFacade.cfc", "RemoteFacadeService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://mxunit/framework/RemoteFacade.cfc", "RemoteFacade.cfc"));
        }
