...
public class RemoteFacadeServiceTestCase extends junit.framework.TestCase {
    ...
    public void testRemoteFacadeCfcWSDL() throws Exception {
        ...
        java.net.URL url = new java.net.URL(new org.mxunit.eclipseplugin.actions.bindings.RemoteFacadeServiceLocator().getRemoteFacadeCfcAddress() + "?WSDL");
        javax.xml.rpc.Service service = serviceFactory.createService(url, new org.mxunit.eclipseplugin.actions.bindings.RemoteFacadeServiceLocator().getServiceName());
        assertTrue(service != null);
    }

    public void test1RemoteFacadeCfcPing() throws Exception {
        org.mxunit.eclipseplugin.actions.bindings.RemoteFacadeCfcSoapBindingStub binding;
        try {
            binding = (org.mxunit.eclipseplugin.actions.bindings.RemoteFacadeCfcSoapBindingStub)
                          new org.mxunit.eclipseplugin.actions.bindings.RemoteFacadeServiceLocator().getRemoteFacadeCfc();
        }
